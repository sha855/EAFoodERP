...
const PhotoFileCard: React.FC<PhotoFileCardProps> = ({
  index,
  item,
  removeTaskFields,
  UpdateTaskFieldData,
    ...
    <div key={index}>
      <div className="mt-4 grid grid-cols-1 gap-6 border-b pb-4">
        <div className="flex justify-between items-center">
          <h3 className="font-bold text-lg">Field: Attach a photo/file</h3>
          <MdDeleteOutline
